...
echo "========================================="
echo "Shutting Down Multi-Cluster Resources"
echo "========================================="
echo ""
...
rm -rf .terraform .terraform.lock.hcl .tofu .tofu.lock.hcl terraform.tfstate terraform.tfstate.backup kubeconfig-cluster-01 kubeconfig-cluster-02
rm -f /tmp/cluster-01.skupper.token
